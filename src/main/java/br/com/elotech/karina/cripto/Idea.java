...
package br.com.elotech.karina.cripto;
...
public class Idea {
    ...
    /**
     * Creates an instance of the IDEA processor, initialized with a 16-byte
     * binary key.
     *
     ...
     * string key.
     *
     * @param charKey A string of ASCII characters within the range 0x21 ..
     *            0x7E.
     * @param encrypt true to encrypt, false to decrypt.
     */
    ...
    // The argument and the result are within the range 0 .. 0xFFFF.
    // The following condition is met for all values of x: mul(x, mulInv(x)) ==
    // 1
    ...
    private static byte[] generateUserKeyFromCharKey(String charKey) {
        ...
        final int nofChar = maxChar - minChar + 1; // Number of different valid
                                                   // characters
        int[] a = new int[8];
